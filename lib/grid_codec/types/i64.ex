defmodule GridCodec.Types.I64 do
      ...
      :little ->
        quote do
          case :maps.get(unquote(field_name), unquote(data_var), unquote(default)) do
            ...
            v ->
              unquote(GridCodec.Types.Integer.validate_signed_ast(quote(do: v), 64, field_name))
  ...
  def coerce_ast(var) do
    GridCodec.Types.Integer.gen_signed_coerce_ast(var, 64, :i64)
  end

  @impl true
  def validate_ast(var, field, mod) do
    GridCodec.Types.Integer.gen_signed_validate_ast(var, field, mod, 64, :i64)
  end
